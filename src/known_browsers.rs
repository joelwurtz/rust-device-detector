...
fn available_browsers() -> HashMap<String, String> {
    [
        ...
        ("M6", "MixerBox AI"),
        ("MO", "Mobicip"),
        ("MU", "Mi Browser"), // Renamed from "MIUI Browser" in PHP 6.4.0
        ("MS", "Mobile Silk"),
        ("MK", "Mogok Browser"),
        ...
        ("P6", "Opus Browser"),
        ("PR", "Palm Pre"),
        ("PU", "Puffin Web Browser"),
        ("5U", "Puffin Web Browser Pro"),
        ("6U", "Puffin Incognito Browser"),
        ("7U", "Puffin Cloud Browser"),
...
fn browser_families() -> HashMap<String, Vec<String>> {
    [
        ...
        (
            "Chrome",
            vec![
                "CH", "2B", "7S", "A0", "AC", "A4", "AE", "AH", "AI", "AL", "AO", "AS", "BA", "BM", "BR",
                "C2", "C3", "C5", "C4", "C6", "CC", "CD", "CE", "CF", "CG", "1B", "CI", "CL", "CM",
                ...
                "SV", "SW", "SY", "SZ", "T1", "T3", "TA", "TB", "TG", "TR", "TS", "TU", "TV", "UB", "UR",
                ...
                "X2", "N3", "GD", "O9", "Q3", "F7", "K2", "K5", "P5", "H5", "V3", "K3", "Q4", "G2", "R2",
                "WX", "XP", "3I", "BG", "R0", "JO", "OL", "GN", "W4", "QI", "E1", "RI", "8B", "5B",
                "K4", "WK", "8C", "3M", "X5", "PU", "5U", "6U", "7U", "TQ", "ZB", "W2", "RA", "3P",
            ],
        ),
        (
            "Firefox",
        ...
        (
            "Internet Explorer",
            vec!["IE", "CZ", "BZ", "IM", "PS", "3A", "4A", "RN"],
        ),
        ("Konqueror", vec!["KO"]),
        ("NetFront", vec!["NF"]),
        ("NetSurf", vec!["NE"]),
        ("Nokia Browser", vec!["NB", "DO", "NO", "NV"]),
        (
            "Opera",
            vec![
                "OP", "OG", "OH", "OI", "OM", "ON", "OO", "O1", "OP", "OX", "Y1",
            ],
        ),
        ("Safari", vec!["SF", "S7", "MF", "SO", "PV"]),
...
pub fn mobile_only_browsers() -> HashSet<String> {
    [
        ...
        "DP", "KL", "K4", "N6", "KU", "WK", "M8", "UP", "ZT", "5U", "6U", "7U",
    ]
    .into_iter()
    .map(|f| f.to_owned())
